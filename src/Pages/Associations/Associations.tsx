				...
				<div className="container-md">
					<section className="intro">
						...
						<p className="intro__text__associations">
							Vous avez la possibilité de rechercher des associations de
							protection animale en fonction de plusieurs critères. Que vous
							cherchiez une association près de chez vous ou une organisation
							spécialisée dans un type d'animal particulier, PetFoster Connect
					...
					<section className="associations__section">
						...
						<div className="cards">
							...
							(associationsFilterCount !== null &&
								associationsFilterCount > 0) ? (
								<PaginationComposant
									items={
