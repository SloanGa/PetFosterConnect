	...
	const handleSubmitForm = async (values: any) => {
		...
		try {
			const response = await fetch(
				`${import.meta.env.VITE_API_URL}/auth/register/${mode}`,
				{
					method: "POST",
					body: formData,
				},
		...
		<>
			...
			<div className="form__presentation">
				...
				<h2 className="form__title">
					...
					{mode === "family" ? "Famille" : "Association"}
				</h2>
			</div>
						...
						<div className="container__register">
							<div className="user__register">
								...
								<Form.Group controlId="formBasicName" className="form__name">
									<Form.Label column="sm">Votre Nom *</Form.Label>
									<Form.Control
							...
							<div className="entity__register">
								<p className="info__form">
									Informations {mode === "family" ? "Famille" : "Association"}
								</p>
								{/* Input adresse */}
								<Form.Group
								...
								>
									<Form.Label column="sm">Votre Adresse *</Form.Label>
									<Form.Control
										className="form__connexion_input"
										type="text"
										name="address"
								...
								>
									<Form.Label column="sm">Votre code postal *</Form.Label>
									<Form.Control
										className="form__connexion_input"
										type="text"
										name="zip_code"
								...
								<Form.Group controlId="formBasicCity" className="form__city">
									<Form.Label column="sm">Votre Ville *</Form.Label>
									<Form.Control
										className="form__connexion_input"
										type="text"
										name="city"
								...
								{mode === "association" ? (
									<Form.Group controlId="formBasicEmailAsso">
										...
										<Form.Control
											...
											onChange={handleChange}
											isInvalid={
												touched.email_association && !!errors.email_association
											}
										/>
										<Form.Control.Feedback type="invalid">
								...
								{mode === "family" ? (
									...
									<Form.Group controlId="formBasicFile" className="form__file">
										<Form.Label column="sm">Votre photo de profil</Form.Label>
										<Form.Control
											className="form__connexion_input"
											type="file"
											name="family_img"
									...
									<Form.Group controlId="formBasicFile" className="form__file">
										...
										<Form.Control
											...
											isInvalid={
												touched.association_img && !!errors.association_img
											}
										/>
										<Form.Control.Feedback type="invalid">
