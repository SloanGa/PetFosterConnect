...
const Connexion = () => {
    ...
    const handleLogin = async (event: FormEvent<HTMLFormElement>) => {
        ...
        /* Si l'un des champs est manquant on arrête l'exécution */
            ...
            <main className="container">
                ...
                <Form className="form__connexion" onSubmit={handleLogin}>
                    <Form.Group controlId="formBasicEmail">
                        <Form.Label column={"sm"} className="label">Votre email</Form.Label>
                        <Form.Control className="input" type="email" name="email" aria-label="Votre email"
                                      placeholder="Votre email" />
                    </Form.Group>

                    <Form.Group controlId="formBasicPassword" className="form__group__password">
                        <Form.Label column={"sm"} className="label">Votre mot de passe</Form.Label>
                        <Form.Control className="input input__password" type={isPasswordVisible ? "text" : "password"}
                                      name="password"
                                      aria-label="Votre mot de passe"
                                      placeholder="Votre mot de passe" ref={passwordInputRef}
                        />
                        <button
                            type="button"
                    ...
                    <Button type="submit"
                            aria-label="Se connecter" className="btn__submit">
                        Se connecter
                    </Button>
