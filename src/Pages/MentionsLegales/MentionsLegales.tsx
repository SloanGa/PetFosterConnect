    ...
    return (
        <>
            <Helmet>
                ...
                <meta
                    name="description"
                    content="Découvrez les mentions légales de PetFoster Connect."
                />
            </Helmet>
            <Header />
            <main>
                ...
                <p className="main__paragraph">
                    ...
                    PetFoster Connect l'identité des différents intervenants dans le cadre de sa
                ...
                <p className="main__paragraph">
                    Le présent site, accessible à l’URL https://www.petfosterconnect.com est édité
                    par :
                </p>

                <p className="main__paragraph">
                    L’association PetFoster Connect, enregistrée auprès de la
                    préfecture/sous-préfecture de 75 - Préfecture Paris sous le numéro W123456789,
                    ayant son siège situé à 1 rue des Echevins 75000 PARIS, représentée par Sloan
                    GAUTHIER dûment habilité(e).
                </p>
                ...
                <p className="main__paragraph">
                    ...
                    59053 Roubaix Cedex 1, (contact téléphonique ou email : 1007).
                </p>
            </main>
