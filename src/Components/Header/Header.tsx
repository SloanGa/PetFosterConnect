        ...
        <header>
            <div className="header__primary">
                ...
                <div className="header__primary__icons">
                    <Icon ariaLabel={"Ouvrir le menu de navigation"} src={"/src/assets/icons/burger-icon.svg"} alt={"icône menu"}/>
                    <Icon ariaLabel={"Ouvrir le menu de connexion ou inscription"} src={"/src/assets/icons/user-connect.svg"} alt={"icône connexion/inscription"}/>
                </div>
